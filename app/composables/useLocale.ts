...
const translations = {
  en: {
    ...
    blog: {
      ...
      subscribeSuccess: 'You\'re subscribed! Check your inbox for a confirmation.',
      subscribeError: 'Something went wrong. Please try again.',
      subscribePrivacy: 'Your email is stored securely at Resend (SOC 2). No spam, unsubscribe anytime and your data is deleted immediately.',
    },
    contact: {
      ...
      submit: 'Send message →',
      success: 'Your message has been sent! I\'ll get back to you within 24 hours.',
    },
    footer: {
  ...
  nl: {
    ...
    blog: {
      ...
      subscribePlaceholder: 'jouw@email.com',
      subscribeBtn: 'Inschrijven →',
      subscribeSuccess: 'Je bent ingeschreven! Check je inbox voor een bevestiging.',
      subscribeError: 'Er ging iets mis. Probeer het opnieuw.',
      subscribePrivacy: 'Je emailadres wordt veilig bewaard bij Resend (SOC 2). Geen spam, uitschrijven kan altijd en je gegevens worden dan onmiddellijk verwijderd.',
    },
    contact: {
      ...
      success: 'Je bericht is verzonden! Ik kom binnen 24 uur bij je terug.',
    },
    footer: {
